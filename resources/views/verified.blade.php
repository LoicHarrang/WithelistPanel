...
<head>
    ...
    <title>Adresse Email vérifé - {{ config('app.name') }}</title>
    ...
    <div class="row">
        <div class="col s12 m8 offset-m2 l6 offset-l3">
            <div class="card-panel">
                <h5>Adresse Email vérifié</h5>
                <p>Vous avez vérifié avec succès votre email.</p>
                <div class="row">
                    <div class="col s12">
                        <a href="{{ url('/') }}" class="btn blue waves-effect">Retour</a>
                    </div>
                </div>
            </div>
